...
Agregue el middleware [morgan](https://github.com/expressjs/morgan) a su aplicación para el registro. Configúrelo para registrar mensajes en su consola según la configuración <i>tiny</i>.
